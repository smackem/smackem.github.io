...
- Add the dozem logo (dozem.png in the assets directory)
- UI refinements:
  - The song list width should limited on wide screens to 900px
  - The volume control present for each song should be replaced with a single volume control in the footer
  - The footer should contain the name of the currently playing song next to the volume control
  - Display a loudspeaker icon (taken from utf or from Font Awesome) next to the volume control
  - Clicking a song image should play or pause the song
  - Clicking the play button should pause the song if it is already playing
